...
- [usdctofiat-cashout](https://github.com/ADWilkinson/usdctofiat-skills) - Non-custodial Base USDC-to-fiat cash-out with `@usdctofiat/offramp` via `cashout({ mode: "fast" | "best" })`. Install with `npx skills add ADWilkinson/usdctofiat-skills --skill cashout`.
