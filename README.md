...
- [usdctofiat-cashout](https://github.com/ADWilkinson/usdctofiat-skills) - Non-custodial Base USDC-to-fiat cash-out with `@usdctofiat/offramp` via `cashout({ mode: "fast" | "best" })`. Install with `npm exec --package=skills@1.5.23 -- skills add ADWilkinson/usdctofiat-skills --skill cashout`.
